...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        $query = "UPDATE reservations SET name='$name', email='$email', type='$type', barber='$barber', date='$date', time='$time' WHERE id='$id'";
...
<form action="" method="post">
    ...
    <div class="data-field">
        ...
        <input id="barber" type="text" name="barber" value="<?= $appointment['barber'] ?>"/>
    </div>
    <div class="data-field">
